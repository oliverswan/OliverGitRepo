...
public class Client {
	...
	public void init() {
		try {
			...
			ks.load(new FileInputStream("src/net/oliver/j2se/security/jsse/demo1/agreeclient.jks"),
					CLIENT_KEY_STORE_PASSWORD.toCharArray());
			tks.load(new FileInputStream("src/net/oliver/j2se/security/jsse/demo1/tagreeclient.jks"),
