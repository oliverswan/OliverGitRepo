package org.example.mina.ssl.threesolutions.solution2.client;
...
public class TSLClientSpring {
	...
	public static ConfigurableApplicationContext getApplicationContext() {
		return new ClassPathXmlApplicationContext("com/sundoctor/mina/example2/ssl/client/clientContext.xml");
	}
}
